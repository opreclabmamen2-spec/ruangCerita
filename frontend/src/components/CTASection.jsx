  ...
  bg-cover bg-center bg-no-repeat relative overflow-hidden"
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <h1 className="text-2xl md:text-3xl font-semibold text-white max-w-2xl leading-snug" data-aos="fade-up"
  data-aos-delay="200">
          Kenali Kondisi Mental Anda dengan Bantuan AI
        </h1>

        <div className="h-[2px] w-20 my-3 bg-gradient-to-r from-transparent via-white to-transparent" data-aos="zoom-in"
  data-aos-delay="350"/>

        <p className="text-sm md:text-base text-white/80 max-w-xl" data-aos="fade-up"
  data-aos-delay="450">
